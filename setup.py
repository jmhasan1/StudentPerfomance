# automatically find out all the poackages in the Machine Learning application (directory)that we have created
...
# whenever find packages is running it will look for folders with __init__ as package as build this
# entire project development will happen inside source folder
